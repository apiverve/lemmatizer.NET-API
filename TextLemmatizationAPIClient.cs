...
namespace APIVerve
{
    public class TextLemmatizationAPIClient
    {
        ...
        public TextLemmatizationAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public TextLemmatizationAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, lemmatizerQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(lemmatizerQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(lemmatizerQueryOptions options)
        {
